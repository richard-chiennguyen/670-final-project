function lgraph = resnet18PD(image_size,num_fully_connected_layers, dropoutRate)
%resnet18PD uses DL model, resnet-18
% takes 3 inputs: image size, number of fully connected layers, dropout
% rate
...
%ADD LAYER GRAPH
tempLayers = [
    imageInputLayer(image_size,"Name","data","Normalization","zscore")
...
tempLayers = [
    ...
    fullyConnectedLayer(num_fully_connected_layers,"Name","fc1000")
