function [lgraph] = xceptionPD(image_size, output_size, dropoutRate)
%xceptionPD uses DL model, Xception, with 2 inputs: imput image size and  
%and number of output classes, and an added dropout layer
% Aug 30, 2022 by PD
...
%ADD LAYER BRANCHES
tempLayers = [
%     imageInputLayer(image_size,"Name","input_1","Normalization","rescale-symmetric")
    imageInputLayer(image_size,"Name","input_1","Normalization", 'none')
...
tempLayers = [
    ...
    fullyConnectedLayer(output_size,"Name","predictions")
